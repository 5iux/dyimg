...
// 将所有页面（pages）加入数组
	...
	$options[] = array(
		'name' => __('PC端顶部Logo'),
		'desc' => __('上传一个尺寸为宽220px，高50px的图片，或者直接输入图片地址福利吧【www.fl8.fun】免费分享'),
		'id' => 'suxingme_logo',
		'type' => 'upload');
	...
	$options[] = array(
		'name' => __('新浪微博链接'),
		'desc' => __('直接输入您的新浪微博链接，别忘了开头带 https:// ，将出现在底栏。'),
		'id' => 'suxingme_social_weibo',
		'type' => 'text');	
		
	$options[] = array(
		'name' => __('pinterest'),
		'desc' => __('直接输入您的pinterest链接，别忘了开头带 https://，将出现在底栏。'),
		'id' => 'suxingme_social_qqweibo',
		'type' => 'text');	
		
	$options[] = array(
		'name' => __('Github'),
		'desc' => __('直接输入您的Github链接，别忘了开头带 https://，将出现在底栏。'),
		'id' => 'suxingme_social_email',
		'type' => 'text');	
		
	$options[] = array(
		'name' => __('Instagram'),
		'desc' => __('直接输入您的Instagram链接，别忘了开头带 https://，将出现在底栏。'),
	...
	$options[] = array(
		...
		"std" => '<a title="福利吧" href="http://www.fl8.fun" target="_blank"><img src="https://ae01.alicdn.com/kf/HTB19YlrafLsK1Rjy0Fb760SEXXac.png" alt="福利吧" /></a>',
		'type' => 'textarea');	
