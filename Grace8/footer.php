	...
	<div class="container">
		<div class="social-footer">
			...
			<?php if(suxingme('suxingme_social_qqweibo')){?>
				<a class="ttweiboii" href="<?php echo suxingme('suxingme_social_qqweibo') ;  ?>" target="_blank" rel="nofollow" title="pinterest"><i class="icon-pinterest"></i></a>
			<?php } ?>
			<?php if(suxingme('suxingme_social_email')){?>
				<a class="mailii" href="<?php echo suxingme('suxingme_social_email');?>"target="_blank"><i class="icon-github"></i></a>
			<?php } ?>
			<?php if(suxingme('suxingme_social_qq')){?>
				<a class="qqii" href="<?php echo suxingme('suxingme_social_qq');  ?>" target="_blank"><i class="icon-instagram"></i></a>
			<?php } ?>
			<?php if(suxingme('suxingme_social_weixin')){?>
				<a id="tooltip-f-weixin" class="wxii" href="javascript:void(0);"><i class="icon-wechat"></i></a>
			<?php } ?>
				<a class="twii" href="https://twitter.com/DubeYang" target="_blank"><i class="icon-twitter"></i></a>
				<a class="driii" href="https://dribbble.com/dyartstyle" target="_blank"><i class="icon-dribbble"></i></a>
		</div>
		...
		<br/>Powered By WordPress · Grace Theme By <a href="http://www.suxing.me" target="_blank">Suxing</a>
		</div>
	</div>
</div>
<?php } else{ ?>
